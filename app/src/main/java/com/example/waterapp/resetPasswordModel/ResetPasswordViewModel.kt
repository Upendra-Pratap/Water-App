...
@HiltViewModel
class ResetPasswordViewModel @Inject constructor(private val application: Application, private val repository: CommonRepository
): AndroidViewModel(application) {
    val progressIndicator = MutableLiveData<Boolean>()
    val errorResponse = MutableLiveData<Throwable>()
    val mRejectResponse = MutableLiveData<Event<ResetPasswordResponse>>()
    ...
    fun resetPassword(
        ...
        repository.resetPassword(
            ...
            .subscribe(object : DisposableObserver<ResetPasswordResponse>() {
                override fun onNext(value: ResetPasswordResponse) {
